...
export default function Index({ menunggu, riwayat }) {
    ...
    return (
        <AppLayout>
            ...
            <PageHeader title="Approval Perubahan Tenor" subtitle={`${menunggu.length} pengajuan menunggu tinjauan Anda`} />
            ...
            <Drawer show={drawerOpen} title={`Tinjau Pengajuan - ${detailPengajuan?.anggota?.nama ?? 'Anggota'}`} onClose={tutupDetail} maxWidth="3xl">
                {detailPengajuan && (
                    <KeputusanDrawer
