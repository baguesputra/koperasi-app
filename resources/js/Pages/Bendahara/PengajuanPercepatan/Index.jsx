...
import { FastForward, ShieldCheck, XCircle } from 'lucide-react';
    ...
    return (
        <AppLayout>
            ...
            <div className="mb-6">
                ...
                <p className="text-base text-slate-400 mt-1">{pengajuan.length} pengajuan menunggu tinjauan</p>
            </div>
            ...
            <Drawer show={drawerOpen} title="Tinjau Percepatan" onClose={tutup}>
...
function Keputusan({ pengajuan, onClose }) {
    ...
    function kirim(aksi) {
        setProcessing(true);
        router.post(
            route('bendahara.pengajuan-percepatan.keputusan', pengajuan.id),
            { aksi, catatan },
